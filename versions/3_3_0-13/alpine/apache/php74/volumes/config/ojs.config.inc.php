...
;base_url = "https://jurnal.big.go.id"
...
smtp_auth = ssl
smtp_username = jurnal.geomatika@big.go.id
smtp_password = 630m@tik@
...
; repository_id = "ojs2.192.168.210.70"
